...
export const StarHotel:React.FC<starHotelProps> =(props) => {
    ...
    return(
        <svg className={`${!props.forcedCategory && 'hover:cursor-pointer'} ${!props.forcedCategory? hotelCategorie >= props.hisCategorie? 'fill-orange':'fill-white' : props.forcedCategory >= props.hisCategorie? 'fill-orange':'fill-white'}`} //4
        ...
        onClick={()=> {props.changeSelected && props.changeSelected(); props.changeSelected && hotelCategorieService.changehotelCategorie(props.hisCategorie)}} //3
