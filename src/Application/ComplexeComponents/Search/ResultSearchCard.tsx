...
export const ResultSearchCard:React.FC<resultSearchCardProps> = (props) => {
    ...
    return(
        <NavLink to={`/index/Place/${props.place.getId()}`} className="flex w-full shadow-md rounded-xl hover:bg-sand">
            <div className="w-56 h-[186px]">
            ...
            <div className=" flex flex-col gap-3 px-4 py-3 w-full">
                <div className="flex justify-between items-center">
                    <div>
                        <h2 className="text-2xl font-bold">{props.place.getName()}</h2>
